...
This resource type manages a [Dynatrace Metric][3]
...
[3]: https://www.dynatrace.com/support/help/how-to-use-dynatrace/metrics
[4]: ./docs/README.md
...
1. Write the JSON schema describing your resource, [dynatrace-environment-metric.json](./dynatrace-environment-metric.json)
2. Implement your resource handlers in [handlers.ts](./dynatrace-environment-metric/handlers.ts)

> Don't modify [models.ts](./dynatrace-environment-metric/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
