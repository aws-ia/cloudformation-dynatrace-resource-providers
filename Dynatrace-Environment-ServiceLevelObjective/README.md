...
This resource type manages a [Dynatrace Service Level Objective][3]
...
[3]: https://www.dynatrace.com/support/help/how-to-use-dynatrace/cloud-automation/service-level-objectives
[4]: ./docs/README.md
...
1. Write the JSON schema describing your resource, [dynatrace-environment-servicelevelobjective.json](./dynatrace-environment-servicelevelobjective.json)
2. Implement your resource handlers in [handlers.ts](./dynatrace-environment-servicelevelobjective/handlers.ts)

> Don't modify [models.ts](./dynatrace-environment-servicelevelobjective/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
