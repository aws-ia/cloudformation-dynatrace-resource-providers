...
1. Write the JSON schema describing your resource, [dynatrace-automation-workflow.json](./dynatrace-automation-workflow.json)
2. Implement your resource handlers in [handlers.ts](./dynatrace-automation-workflow/handlers.ts)

> Don't modify [models.ts](./dynatrace-automation-workflow/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
