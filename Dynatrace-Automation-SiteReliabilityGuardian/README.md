...
1. Write the JSON schema describing your resource, [dynatrace-automation-sitereliabilityguardian.json](./dynatrace-automation-sitereliabilityguardian.json)
2. Implement your resource handlers in [handlers.ts](./dynatrace-automation-sitereliabilityguardian/handlers.ts)

> Don't modify [models.ts](./dynatrace-automation-sitereliabilityguardian/models.ts) by hand, any modifications will be overwritten when the `generate` or `package` commands are run.
